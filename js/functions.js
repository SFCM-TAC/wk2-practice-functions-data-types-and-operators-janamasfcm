...
function sayHelloEverybody(Jana Emily Maryclare) {
  ...
  var sayHelloEverybody = 'Jana Emily Maryclare'
}

function getClasses(Art, Mathematics, and Dance) {
  // TODO: return an array with a list of strings
  // naming the classes you are taking this semester
  var getClasses = 'Art, Mathematics, and Dance'
}

function labelOrder(22237) {
  ...
  var labelOrder = '22237'
}

function calculateVolume(1, 2, 3) {
  // TODO: given a room's width, length, and height
  // write a function that returns the volume
    var calculateVolume = '1, 2, 3'
}

function isOdd(hereismyquestion) {
...
function getSalePrices(100 dollars) {
  ...
  // NOTE: inputs should be an array with exactly three items
  var result = getSalePrice ("100 dollars")
}

 // ** COUNTING ** //

var counter = 0;
function incrementCounter(123456) {
